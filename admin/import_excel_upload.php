...
if($_FILES) {  //ถ้ามีอินพุทชนิด file ส่งเข้ามา
	...
	$result = mysqli_query($link,$sql);
		...
		$sql = "load data local infile '".$_FILES['file']['name']."' into table usertbl fields terminated by ',' lines terminated by '\n'ignore 1 lines (user, password, name, status, class);";
		$result = mysqli_query($link,$sql);
		echo "import employee file successfully";
